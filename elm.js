...
var $author$project$Main$fissionColors = {
	bg: A3($mdgriffith$elm_ui$Element$rgb255, 30, 35, 71),
	bgLight: A3($mdgriffith$elm_ui$Element$rgb255, 100, 70, 250),
...
var $author$project$Main$paletteDark = {
	...
	icon: $author$project$Main$white,
	link: A3($mdgriffith$elm_ui$Element$rgb255, 51, 179, 166),
	linkHover: $author$project$Main$fissionColors.cyan,
	outerBg: $author$project$Main$black,
...
var $author$project$Main$paletteLight = {
	...
	footerText: $author$project$Main$grey,
	icon: $author$project$Main$black,
...
var $author$project$Main$getPalette = function (model) {
	...
	switch (_v0.$) {
		...
		default:
			return $author$project$Main$paletteFission;
	}
};
...
var $author$project$Main$getSubtitle = function (model) {
	...
	switch (_v0.$) {
		case 'Light':
			return $mdgriffith$elm_ui$Element$text('Because Math');
		case 'Dark':
			return $mdgriffith$elm_ui$Element$text('Fission Rocks');
		default:
			return $mdgriffith$elm_ui$Element$text('Fission colors!');
	}
};
...
var $author$project$Main$toggleTheme = function (model) {
	...
	switch (_v0.$) {
		case 'Light':
			return $author$project$Main$SetTheme($author$project$Main$Dark);
		case 'Dark':
			return $author$project$Main$SetTheme($author$project$Main$Fission);
		default:
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$ariaLabel('Fission Forum')
					]),
				{
					label: $author$project$Main$faIcon('fas fa-archive'),
					url: 'https://talk.fission.codes/'
				}),
				A2(
				$mdgriffith$elm_ui$Element$newTabLink,
				_List_fromArray(
					[
						$author$project$Main$getLinkHover(model),
						$author$project$Main$getIconColor(model),
						$author$project$Main$ariaLabel('Blog')
					]),
				{
					label: $author$project$Main$faIcon('fab fa-blogger'),
					...
					]),
				{
					...
					url: 'https://github.com/fission-suite/'
				}),
				A2(
				$mdgriffith$elm_ui$Element$newTabLink,
				_List_fromArray(
					...
					]),
				{
					...
					url: 'https://www.linkedin.com/company/fissioncodes/'
				})
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Font$color(palette.defaultText)
			]),
		A2(
				...
				[
								...
								[
									...
									_List_fromArray(
										[
											...
											$mdgriffith$elm_ui$Element$Font$color(palette.secondaryText)
										]),
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$Font$color(palette.footerText),
							$mdgriffith$elm_ui$Element$Font$light,
							$mdgriffith$elm_ui$Element$centerX,
							$mdgriffith$elm_ui$Element$Font$center,
							...
							_List_fromArray(
								[
										...
										]),
									{
										...
										url: 'https://github.com/forgondolin/forgondolin.github.io'
									}),
